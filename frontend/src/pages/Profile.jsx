      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            disabled={loggingOut}
            className="rounded-2xl bg-gradient-to-r from-[#FFA500] via-[#FF7518] to-[#FF5F1F] px-4 py-2.5 text-sm font-semibold text-white shadow-md shadow-[#FF7518]/25 transition-transform duration-200 hover:-translate-y-0.5 active:scale-[0.98] disabled:opacity-60"
          >
        ...
        <div className="grid gap-6 lg:grid-cols-[84px_1fr]">
          ...
          <div className="space-y-6">
            <section className="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-lg shadow-[#FF7518]/10 ring-1 ring-stone-200/60 dark:border-white/10 dark:bg-stone-950/60 dark:ring-white/10 sm:p-8">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-4">
                  <div className="relative h-16 w-16 overflow-hidden rounded-full bg-gradient-to-br from-[#FFA500] via-[#FF7518] to-[#FF5F1F] p-[2px] shadow-md shadow-[#FF7518]/25">
                    <div className="flex h-full w-full items-center justify-center overflow-hidden rounded-full bg-white dark:bg-stone-950">
                      {avatarPreview ? (
                        ...
                        <span className="text-sm font-bold text-[#7a2b00] dark:text-stone-100">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 text-xs font-medium text-[#a33a00]/85 dark:text-stone-300">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <label
                    ...
                    className="cursor-pointer rounded-2xl border border-[#FFA500]/35 bg-white px-4 py-2 text-sm font-semibold text-[#7a2b00] shadow-sm transition-all duration-200 hover:bg-[#FFA500]/10 dark:bg-white/5 dark:text-stone-200 dark:ring-1 dark:ring-white/10 dark:hover:bg-white/10"
                  >
                    Upload
                  </label>
                  <input
                  ...
                  {!editing ? (
                    <button
                      type="button"
                      onClick={startEdit}
                      className="rounded-2xl bg-gradient-to-r from-[#FFA500] via-[#FF7518] to-[#FF5F1F] px-4 py-2 text-sm font-semibold text-white shadow-md shadow-[#FF7518]/25 transition-transform duration-200 hover:-translate-y-0.5 active:scale-[0.98]"
                    >
                      Edit
                    </button>
                  ) : (
                    <>
                      <button
                        ...
                        onClick={cancelEdit}
                        disabled={saving}
                        className="rounded-2xl border border-stone-200 bg-white px-4 py-2 text-sm font-semibold text-stone-700 shadow-sm transition-all duration-200 hover:bg-stone-50 disabled:opacity-60 dark:border-white/10 dark:bg-white/5 dark:text-stone-200 dark:hover:bg-white/10"
                      >
                        Cancel
                      </button>
                      <button
                        ...
                        onClick={saveEdit}
                        disabled={saving}
                        className="rounded-2xl bg-gradient-to-r from-[#FFA500] via-[#FF7518] to-[#FF5F1F] px-4 py-2 text-sm font-semibold text-white shadow-md shadow-[#FF7518]/25 transition-transform duration-200 hover:-translate-y-0.5 active:scale-[0.98] disabled:opacity-60"
                      >
                        {saving ? "Saving..." : "Save"}
                      </button>
                    </>
              ...
              {formError ? (
                <div className="mt-4 rounded-2xl border border-red-200/80 bg-red-50/90 px-4 py-3 text-sm text-red-800 dark:border-red-900/50 dark:bg-red-950/40 dark:text-red-200">
                  {formError}
                </div>
              ) : null}
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    value={user?.fullName || ""}
                    readOnly
                    className="mt-1.5 w-full rounded-2xl border border-stone-200/90 bg-stone-50 px-4 py-3 text-sm text-stone-700 shadow-inner outline-none dark:border-white/10 dark:bg-white/5 dark:text-stone-200"
                  />
                </div>
                <div>
                  <label className="text-xs font-semibold text-stone-600 dark:text-stone-300">
                ...
                <div>
                  ...
                  <input
                    value={editing ? draft.country : localProfile.country}
                    onChange={(e) =>
                      setDraft((d) => ({ ...d, country: e.target.value }))
                    }
                    readOnly={!editing}
                    placeholder="Your country"
                    className="mt-1.5 w-full rounded-2xl border border-stone-200/90 bg-white px-4 py-3 text-sm text-stone-900 shadow-sm outline-none transition-all duration-200 focus:ring-2 focus:ring-[#FF7518]/35 disabled:opacity-60 dark:border-white/10 dark:bg-stone-950/40 dark:text-stone-100 dark:placeholder:text-stone-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    value={editing ? draft.gender : localProfile.gender}
                    onChange={(e) =>
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    value={editing ? draft.bio : localProfile.bio}
                    onChange={(e) =>
                    ...
                    className="mt-1.5 w-full resize-y rounded-2xl border border-stone-200/90 bg-white px-4 py-3 text-sm text-stone-900 shadow-sm outline-none transition-all duration-200 focus:ring-2 focus:ring-[#FF7518]/35 dark:border-white/10 dark:bg-stone-950/40 dark:text-stone-100 dark:placeholder:text-stone-500"
                  />
                  <p className="mt-1 text-xs text-stone-500 dark:text-stone-400">
                    {String((editing ? draft.bio : localProfile.bio) || "").length}/240
                  </p>
                </div>
              </div>
            </section>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <section className="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-lg shadow-[#FF7518]/10 ring-1 ring-stone-200/60 dark:border-white/10 dark:bg-stone-950/60 dark:ring-white/10">
                ...
                <p className="mt-1 text-xs text-stone-500 dark:text-stone-400">
                  Mock data (walking module will plug in here)
                </p>
              ...
              <section className="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-lg shadow-[#FF7518]/10 ring-1 ring-stone-200/60 dark:border-white/10 dark:bg-stone-950/60 dark:ring-white/10">
                ...
                <p className="mt-1 text-xs text-stone-500 dark:text-stone-400">
                  Mock data (reward history integration ready)
                </p>
                <div className="mt-4 space-y-3">
                  {mockRedeems.map((r) => (
                    <RedeemItem key={r.id} item={r} />
                  ))}
                </div>
              </section>
            </div>
            ...
            <section className="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-lg shadow-[#FF7518]/10 ring-1 ring-stone-200/60 dark:border-white/10 dark:bg-stone-950/60 dark:ring-white/10">
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-xs text-stone-500 dark:text-stone-400">
                    Gamification (mock earned badges)
                  </p>
                </div>
                <div className="rounded-full bg-gradient-to-r from-[#FFA500]/18 to-[#FF5F1F]/12 px-3 py-1 text-xs font-semibold text-[#7a2b00] ring-1 ring-[#FFA500]/25 dark:bg-white/10 dark:text-stone-200 dark:ring-white/10">
            ...
            <section className="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-lg shadow-[#FF7518]/10 ring-1 ring-stone-200/60 dark:border-white/10 dark:bg-stone-950/60 dark:ring-white/10">
              ...
              <p className="mt-1 text-xs text-stone-500 dark:text-stone-400">
                Showing last {Math.min(5, recentNotifications.length)} items
              </p>
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                {recentNotifications.length === 0 ? (
                  <div className="rounded-2xl border border-stone-200/70 bg-stone-50 px-4 py-4 text-sm text-stone-600 dark:border-white/10 dark:bg-white/5 dark:text-stone-300 sm:col-span-2">
                  ...
                  recentNotifications.map((n) => (
                    <div
                      key={n.id}
                      className={`rounded-2xl border px-4 py-3 shadow-sm ring-1 transition-all duration-200 ${
                        n.read
                          ? "border-stone-200/70 bg-white/80 ring-stone-200/60 dark:border-white/10 dark:bg-white/5 dark:ring-white/10"
                          : "border-[#FFA500]/35 bg-gradient-to-br from-[#FFA500]/12 to-[#FF5F1F]/8 ring-[#FFA500]/20 dark:border-[#FFA500]/30 dark:bg-white/10 dark:ring-white/10"
                      }`}
                    >
                      ...
                      <p className="mt-1 text-xs text-stone-500 dark:text-stone-400">
                        {formatNotifTime(n.timestamp)} • {n.type}
                      </p>
                    </div>
                  ))
                )}
