...
export default function AdviceList({ advices, loading, onDelete, onEdit }) {
  if (loading)
    return (
      <div className="py-20 text-center animate-pulse text-stone-400">
        Loading advices...
      </div>
    );
  if (advices.length === 0)
    return (
      <div className="py-20 text-center text-stone-500">No records found.</div>
    );
      ...
      <table className="w-full text-left text-sm">
        <thead className="bg-stone-50 border-b border-stone-200">
          <tr>
            ...
            <th className="px-6 py-4 font-bold text-stone-700">
              Trigger Logic
            </th>
            <th className="px-6 py-4 font-bold text-stone-700">
              Priority/Severity
            ...
            <th className="px-6 py-4 text-right font-bold text-stone-700">
              Actions
            </th>
          </tr>
        </thead>
            ...
            >
              ...
              <td className="px-6 py-4">
                <div className="flex flex-col gap-1">
                  ...
                  <span className="text-[10px] text-stone-400 font-medium tracking-tighter">
              ...
              <td className="px-6 py-4 text-right space-x-3">
                <button
                  onClick={() => onEdit(item)} // Pass the whole object to the parent
