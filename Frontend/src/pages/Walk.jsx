  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
      ...
      >
        ...
        <h1 style={{ margin: 0, fontSize: "34px", color: "#d56a00" }}>
          Plan your walk
        </h1>
        <p style={{ margin: "10px 0 0 0", color: "#666", lineHeight: "1.6" }}>
          Search your destination, get a walking estimate, and earn points while
            ...
            {estimate && (
              ...
              >
                ...
                <p style={{ margin: "6px 0" }}>
                  CO₂ Saved: {estimate.co2SavedKg} kg
                </p>
